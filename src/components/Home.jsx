...
const Home = () => {
  return (
    <>
    <div name="home" className="flex items-center justify-center w-full p-4 relative pt-[100px]">
    <div className="bg-gradient-to-b h-[calc(100vh-150px)] sm:h-full from-white/60 to-white/30 text-[#1c0708] backdrop-blur-[.5em] border-[1px] border-solid border-white border-opacity-10 rounded-2xl shadow-black/50  overflow-hidden shadow-2xl hover:-translate-y-1 hover:shadow-black/75 hover:backdrop-blur-[1em] transition">
        ...
        <div className="col-span-3 p-8">
            <h2 className="mb-4 text-2xl font-bold">Powerful Hosting For Your Dream Website</h2>
        ...
        <div className="col-span-3 mt-5 mb-10">
            <img className="" width="300px" height="300px" src={require('../assets/social-media-users-1721889.png')} alt="pic"/>
        </div>
        </div>
    </div>
    </div>
