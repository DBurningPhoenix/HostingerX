...
const Register = () => {
  return (
    <>
  <div name="register" className="form-wrapper 
   min-h-screen
   [ p-4 md:p-6 lg:p-8 ]
   [ flex justify-center items-center ]">
    <form className="signup-form
      ...
      <p className="mb-6 [ text-sm text-[#1A2421]/70 text-opacity-50 ]">Enter a valid email email &amp; password in the fields below to get started.</p>
      <label htmlFor="email" className="form-label relative block mb-4 text-black/50 focus-within:text-[#333]">
        <svg className="label-icon 
            ...
            [ transform -translate-y-1/2 ]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      ...
      <label htmlFor="password" className="form-label relative text-black/50 focus-within:text-[#333] block mb-4">
        <svg className="label-icon 
            transition pointer-events-none
            [ w-6 h-6 ] 
            [ absolute top-1/2 left-3 ] 
        ...
        <input className="block w-full rounded-lg leading-none focus:outline-none placeholder-black/50 
              [ transition-colors duration-200 ] 
              [ py-3 pr-3 md:py-4 md:pr-4 lg:py-4 lg:pr-4 pl-12 ] 
              [ bg-black/20 focus:bg-black/25 ] 
              [ text-[#333] focus:text-black ]" type="password" name="password" id="password" placeholder="Password" />{/* .form-input */}
      </label>{/* .form-label */}
      ...
      <div className="mt-8 text-center form-footer">
        <p className="text-xs">or Sign in with</p>
        <ul className="flex justify-center mt-4 form-list">
          <li className="mx-1">
            <a href="!#" className="rounded-full bg-[#DB4437] hover:shadow-lg
              [ transform transition hover:-translate-y-1 ]
              [ w-10 h-10 ]
              [ flex justify-center items-center ]">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 fill-white" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 640 640">
          ...
          <li className="mx-1">
            <a href="!#" className="rounded-full bg-[#1DA1F2] hover:shadow-lg
              [ transform transition hover:-translate-y-1 ]
              [ w-10 h-10 ]
              [ flex justify-center items-center ]">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 fill-white" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 640 640">
          ...
          <li className="mx-1">
            <a href="!#" className="rounded-full bg-[#4267B2] hover:shadow-lg
              [ transform transition hover:-translate-y-1 ]
              [ w-10 h-10 ]
              [ flex justify-center items-center ]">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 fill-white" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 640 640">
